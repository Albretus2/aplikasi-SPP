<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li>
        <a href="../petugas/entry-transaksi.php" class="nav-link"><i class="fas fa-dollar-sign"></i> <span>Entry transaksi</span></a>
      </li>
      <li>
        <a href="../petugas/history.php" class="nav-link "><i class="fas fa-history"></i> <span>History pembayaran</span></a>
      </li>
